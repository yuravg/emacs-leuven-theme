...
To load the gray theme, add the following to your =.emacs= file:

#+begin_src emacs-lisp
(load-theme 'leuven-gray t)
#+end_src

To use the gray theme with [[https://github.com/jwiegley/use-package][use-package]], use the following:
