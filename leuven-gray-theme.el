...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-quote ((,class ,code-block)))
   `(org-verse ((,class ,code-block)))
   ...
   ;; remove 'fixed-pitch' inheritance
   `(org-table ((,class (:foreground "Blue1" :inherit nil))))
   `(org-verbatim ((,class (:inherit shadow))))
   `(org-meta-line ((,class (:inherit font-lock-comment-face))))
   `(org-formula ((,class (:foreground "Firebrick" :inherit nil))))
   ...
   `(cperl-hash-face ((,class (:foreground "DodgerBlue3" :background "gray95"))))
   `(cperl-array-face ((,class (:foreground "blue1" :background "gray94"))))
   ...
   ;; Elisp
   `(eros-result-overlay-face ((,class (:foreground "black" :background "#CDFFCD" :box (:line-width -1 :color "blue3")))))
   ;; help-fns+
   `(describe-variable-value ((,class (:foreground "blue4"))))
   ;; fixed-pitch
   `(fixed-pitch ((,class (:inherit default)))) ; Default: Family: Monospace

   ;; Help
   `(help-for-help-header ((,class (color))))
   `(help-key-binding ((,class (:foreground "DarkBlue" :background "gray96"))))
